    ...
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                ...
                </span> Tambah Data Peserta PKL
            </h3>
        </div>

        <div class="card shadow-lg">
            <div class="card-body">
                <h4 class="card-title text-center text-primary fw-bold">FORMULIR PESERTA PKL</h4>
                <br>
                <form action="<?= base_url('siswa/PKL/store') ?>" method="post">
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        ...
                        <a href="<?= base_url('siswa/PKL/siswaPKL') ?>" class="btn btn-gradient-secondary shadow-sm">
