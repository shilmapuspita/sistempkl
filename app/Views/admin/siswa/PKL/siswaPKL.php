                ...
                <div class="card shadow-lg">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="<?= base_url('/siswa/PKL/create') ?>" class="btn btn-gradient-primary btn-sm shadow-sm">
                                    ...
                                    <?php foreach ($datasiswa as $siswa) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('/siswa/PKL/edit/' . $siswa['ID_PKL']) ?>" class="text-warning me-2 text-decoration-none" data-bs-toggle="tooltip" title="Edit">
                                                    <i class="bi bi-pencil-square fs-5 align-middle"></i>
                                                </a>
                                                <a href="<?= base_url('/siswa/PKL/delete/' . $siswa['ID_PKL']) ?>" class="text-danger text-decoration-none" data-bs-toggle="tooltip" title="Delete" onclick="return confirm('Yakin ingin menghapus data ini?')">
