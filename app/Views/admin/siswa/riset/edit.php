    ...
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                ...
                </span> Edit Data Peserta Riset
            </h3>
        </div>

        <div class="card shadow-lg">
            <div class="card-body">
                <h4 class="card-title text-center text-primary fw-bold">FORMULIR EDIT PESERTA RISET</h4>
                <br>
                <form action="<?= base_url('siswa/riset/update/' . $siswa['ID_PKL']) ?>" method="post">
                    <?= csrf_field() ?>
