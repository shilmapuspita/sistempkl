    ...
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                ...
                </span> Add Data Program Studi
            </h3>
        </div>
        <div class="card shadow-lg">
            <div class="card-body">
                <h4 class="card-title text-center text-primary fw-bold">FORMULIR DATA PROGRAM STUDI</h4>
                <br>
                ...
                <?php endif; ?>
                        ...
                        <?= csrf_field() ?>
                            <div class="form-group">
                                <label><i class="fa-solid fa-briefcase"></i> Nama Program Studi</label>
